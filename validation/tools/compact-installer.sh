...
if [ -n "${COMPACT_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URL="${INSTALLER_BASE_URL}/midnightntwrk/compact/releases/download/compact-v0.5.2"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.30.3"},"source":{"app_name":"compact","name":"compact","owner":"midnightntwrk","release_type":"github"},"version":"0.5.2"}
EORECEIPT
...
The installer for compact 0.5.2

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/midnightntwrk/compact/releases/download/compact-v0.5.2
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "compact-aarch64-apple-darwin.tar.xz")
            ...
            _checksum_value="2c2595682ec4f72b3652521f0d1c4124315b169c9e699aae23c1368689e1f750"
            _bins="compact"
        ...
        "compact-aarch64-unknown-linux-musl.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="853180a16dc4115f4f794b1de0aae43573dcc65b6c75225c11520b0df203dd72"
            _bins="compact"
            _bins_js_array='"compact"'
            _libs=""
            _libs_js_array=""
        ...
        "compact-x86_64-apple-darwin.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="cb708f57c66319e0536bf40d7b23d0ca6fe4e0a3bf8ab87dd9f69c07b95850a6"
            _bins="compact"
            _bins_js_array='"compact"'
            _libs=""
            _libs_js_array=""
        ...
        "compact-x86_64-unknown-linux-musl.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="da594f9edfe8d87312c0c500443702b5cfa9d7e17c43433b6ed6580a36278ac8"
            _bins="compact"
            _bins_js_array='"compact"'
            _libs=""
            _libs_js_array=""
